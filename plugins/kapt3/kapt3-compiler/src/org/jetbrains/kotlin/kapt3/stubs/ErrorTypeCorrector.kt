...
class ErrorTypeCorrector(
    ...
    private fun convert(type: SimpleType): JCTree.JCExpression {
        ...
        return treeMaker.Type(converter.kaptContext.typeMapper.mapKotlinType(type))
    }
    ...
    private fun convertUserType(type: KtUserType, substitutions: SubstitutionMap): JCTree.JCExpression {
        ...
        when (target) {
            ...
            is ClassConstructorDescriptor -> {
                val asmType = converter.kaptContext.typeMapper
                    .mapKotlinType(target.constructedClass.defaultType, TypeMappingMode.GENERIC_ARGUMENT)
            ...
            is ClassDescriptor -> {
                ...
                val asmType = converter.kaptContext.typeMapper
                    .mapKotlinType(target.defaultType, TypeMappingMode.GENERIC_ARGUMENT)
